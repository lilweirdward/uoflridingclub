<%@ Page Title=" | Blog" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EquineClub.news.blog.Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div class="container">
        ...
        <h1>Blog Title</h1>
        <a href="post.aspx?id=1"><img src="/images/about-image.jpg" class="blog" /></a>
        <span class="smaller">Posted: 01/01/2014 12:00:00</span>
        <p class="justify">
        ...
        <a href="post.aspx?id=1">Read More...</a>
        ...
        <div style="clear: both; margin: 4rem 0;"></div>
